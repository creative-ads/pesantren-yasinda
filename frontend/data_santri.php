...
if ($keyword) {
    ...
    $sql = "SELECT * FROM santri WHERE nama LIKE ?";
...
<body>
    ...
    <section class="content-santri" id="data">
        <hr class="animated-hr">
        <h1 class="hone"> <i class="fa fa-server"></i> Data Santri</h1>
        <hr class="anm-hr">
        ...
        <div class="card shadow-lg p-3">
                    ...
                    <tbody>
                        <?php foreach ($data as $row): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end"><?= htmlspecialchars($row['alamat']); ?></td>
                            </tr>
                            <?php
                            ...
                            $hariInggris = date('l', strtotime($row['tahun_masuk']));
                            ...
                            ?>
                            <tr>
                                <td class="text-start">Tahun Masuk</td>
                                <td class="text-end"><?php echo $hari . ', ' . date('d-m-Y', strtotime($row['tahun_masuk'])); ?></td>
                            </tr>
                        <?php endforeach; ?>
                        <!-- Baris untuk Pencapaian -->
                        <tr>
                            <td class="text-start">Wali</td>
                            <td class="text-end"><?= htmlspecialchars($row['wali']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-start">Jenis Kelamin</td>
                            <td class="text-end"><?= htmlspecialchars($row['jenis_kelamin']); ?></td>
                        </tr>
            ...
            <?php elseif (isset($_GET['search']) && empty($data)): ?>
                <p class="text-center mt-3">Nama santri tidak terdaftar.</p>
            <?php endif; ?>
        </div>
