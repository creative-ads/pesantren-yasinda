...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO ppdb (judul, keterangan, browsur, browsur_type, berkas, jenjang) 
            VALUES ('$judul', '$keterangan', '$browsur', '$browsur_type', '$berkas', '$jenjang')";

    if (mysqli_query($koneksi, $sql)) {
        echo "Data berhasil diunggah.";
        header('Location: ppdb.php'); // Redirect ke halaman sukses (opsional)
    } else {
