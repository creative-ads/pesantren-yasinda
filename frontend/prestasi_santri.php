...
if ($keyword) {
    ...
    $sql = "SELECT * FROM prestasi WHERE nama LIKE ?";
...
<body>
    ...
    <section class="content-santri" id="prestasi">
        <hr class="animated-hr">
        <h1 class="hone"> <i class="fa fa-medal"></i> Prestasi Santri</h1>
        <hr class="anm-hr">
        ...
        <div class="card shadow-lg p-3">
                ...
                <table class="table">
                    <tbody>
                        <?php foreach ($data as $row): ?>
                            ...
                            <tr>
                                <td class="text-start">Pencapaian</td>
                                <td class="text-end"><?= htmlspecialchars($row['pencapaian']); ?></td>
                            </tr>
            ...
            <?php elseif (isset($_GET['search']) && empty($data)): ?>
                <p class="text-center mt-3">Satri tidak mempunyai prestasi.</p>
            <?php endif; ?>
        </div>
