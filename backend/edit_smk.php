...
include('../koneksi.php');
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM smk WHERE id='$id'");
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            <form action="update_smk.php" method="post" enctype="multipart/form-data">
                <h2 class="form-title">Edit Kuota SMK </h2>
