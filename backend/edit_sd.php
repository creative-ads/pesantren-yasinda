...
include('../koneksi.php');
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM sd WHERE id='$id'");
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            <form action="update_sd.php" method="post" enctype="multipart/form-data">
                <h2 class="form-title">Edit Kuota SD </h2>
