...
include('../koneksi.php');
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM tk WHERE id='$id'");
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            <form action="update_tk.php" method="post" enctype="multipart/form-data">
                <h2 class="form-title">Edit Kuota TK </h2>
